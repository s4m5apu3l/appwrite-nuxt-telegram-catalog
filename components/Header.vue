...
// const changeTheme = () => {
//     PrimeVue.changeTheme('test-dark', 'light', 'theme-link-light', () => {});
// };
...
<template>
    <header class="flex items-center justify-between py-4">
        <NuxtLink to="/">
            <img class="w-[60px] h-[60px]" src="~/assets/img/logo.svg" alt="logo recyclce" />
        </NuxtLink>
        ...
        <!-- <button @click.stop="visibleRight = true" class="relative w-10">
            <div class="flex flex-col gap-2">
                <span class="bg-green-400 rounded-xl py-0.5 w-full"></span>
                <span class="bg-green-400 rounded-xl py-0.5 w-full"></span>
                <span class="bg-green-400 rounded-xl py-0.5 w-full"></span>
            </div>
        </button>
        ...
        <Sidebar
            ...
            header="Меню"
            class="p-4 p-sidebar p-component p-input-filled p-ripple-disabled layout-config layout-dark"
            position="right"
        >
            <nav class="">
                <ul>
